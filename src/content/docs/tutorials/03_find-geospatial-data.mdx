...
Not sure how to best evaluate a geospatial dataset to determine if it is appropriate to use in your project? Learn more in this tutorial on [Evaluating Geospatial Information](https://gin.btaa.org/tutorials/04_evaluate-geospatial-information/).
