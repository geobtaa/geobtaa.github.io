...
<Steps>
1. Navigate to the [BTAA Geoportal](https://geo.btaa.org/). Search for "Leaking Underground Storage Tanks in Iowa.”

2. (Optional) In the results, under “Limit your search,” scroll down to “Resource Class” and click “Web Services.” This will limit your results to web services (not needed here, but it will help if you have many search results).

3. Click the result entitled Leaking Underground Storage Tanks Locations in Iowa [Iowa].

4. On the right side of the screen, below the locator map, click the button to “Open in ArcGIS” (even if you are not using ArcGIS Pro) to obtain the web location for the feature service. Copy the URL of the “REST service details” either from the pop-up window or - if your browser opens a new tab - from the address bar of the service landing page.
</Steps>
