...
<TwoThirdsLayout>
  <div slot="left">
  ![IGeoportal Homepage](@images/tut2maps-homefindmaps.jpg)
...
This section shows a sample search for old maps of Greenland.
<TwoThirdsLayout>
  <div slot="left">
  ![Greenland Map Search](@images/tut2maps-searchresults.jpg)
    *Search for an old map of Greenland*
   </div>
  <div slot="right">

  <Steps>
    1. Enter the word `Greenland` in the keyword search box at the top of the homepage, or zoom in on Greenland on the map and click the orange **Search here** button in the upper left corner.

    2. On the search results page, you can use facets on the lower left side of the page to filter your results. Using the **Year** facet, type `1800` in **End Year** and click **Apply**. 
...
<TwoThirdsLayout>
  <div slot="left">
  ![IGreenland Map](@images/tut2maps-imageresults.jpg)
...
<TwoThirdsLayout>
  ...
  *Metadata for the map*
  ...
  <div slot="right">
  <Steps>
  5. Scroll down to see the **Full Details** of the item below the image. These can help you decide if the item is useful for your research needs.
  </Steps>
  </div>
</TwoThirdsLayout>
...
<TwoThirdsLayout>
  ...
  <div slot="right">
  <Steps>
  6. To cite an image, see the **Cite & Reference** box. First, use the dropbox to select your citation style (APA, MLA, or Chicago). Then, click the button with two boxes to copy the citation. You can then paste it into another document, slideshow, etc.
  </Steps>
  </div>
</TwoThirdsLayout>
...
<TwoThirdsLayout>
  ...
  *The map hosted at the University of Minnesota*
  ...
  <div slot="right">
  <Steps>
  7. Click the **Visit Source** button (located in the Links box just above the Cite & Reference box) to take a closer look! You've now left the Geoportal and are on the University of Minnesota's digital library, UMedia. Sources go to a variety of sites with their own characteristics and options. You may find additional details and downloads at the source website.
  </Steps>
  </div>
</TwoThirdsLayout>
