...
[View this plat in the BTAA Geoportal](https://geo.btaa.org/resources/t027r20w4fi01)
</CenterLayout>
...
*Example of linked survey notes for T01N R01W for Wisconsin found in the Description section*
[View these survey notes in the BTAA Geoportal](https://geo.btaa.org/resources/YDJQVZ6YT33PR86)
</CenterLayout>
...
* [You can use this direct link to browse items in the collection](https://geo.btaa.org/search?include_filters%5Bpcdm_memberOf_sm%5D%5B%5D=77f-0001&view=list)
...
* **Option 1**: Focus the map on the search results page to your area of interest. Use the map tools (+ -) to zoom to your desired area.

* **Option 2**: Click on a term in the Place facet. Most PLSS maps have state and county names attached. 

* **Option 3**: Use the text box to search by Township Ranges. For example, use the format "[T063N-R18W](https://geo.btaa.org/search?q=T063N-R18W&view=list)" for Township 64 North Range 18 West.
