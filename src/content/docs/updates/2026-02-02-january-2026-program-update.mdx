...
<a href="https://gin.btaa.org/posts/applying-deep-learning-models-to-btaa/ ">Read the tutorial: Applying deep learning models to BTAA Geoportal collections.</a>
...
Note: We are investigating and correcting an issue where Google may have incorrectly indexed one of our metadata pages as a live data source.
</ChipList>
...
| :---- | -----: | -----: |
Full Scan and replacement of all records from ArcGIS Hubs | 21592 | 625 | 
Full Scan and replacement of all records from Humanitarian Data Exchange | 11226 | 74 | 
Full replacement of UW DCC plat maps | 2590 | 2524 | 
