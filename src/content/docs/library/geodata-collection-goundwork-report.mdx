...
<CardGrid>
<Card title="Data Dictionary Preview">

![Preview of a data dictionary table for the Amtrak Station Locations dataset.](@images/pilot-dict1.png)

Screenshot of Data Dictionary preview ([https://geodev.btaa.org/catalog/btaa-e4a8461e-6cd1-4c45-b6e8-5838bfe6bde3](https://geodev.btaa.org/catalog/btaa-e4a8461e-6cd1-4c45-b6e8-5838bfe6bde3))

</Card>
<Card title="Nested Values Preview">

![Preview of a data dictionary table showing nested values for an aquifer dataset.](@images/pilot-dict2.png)

Screenshot of data dictionary with nested values. ([https://geodev.btaa.org/catalog/btaa-0d1f5c0e-f93f-4889-be34-16104f9c6927](https://geodev.btaa.org/catalog/btaa-0d1f5c0e-f93f-4889-be34-16104f9c6927))
