...
- [Urban Base Layers Curation Strategy](/library/urban-curation-strategy/)
- [Curation Plan, version 1](https://drive.google.com/file/d/1YRro4a98Hi-W1iduV_TF1Ic_vp2uMcz5/view)
- [Phase 2 Report: Groundwork](/library/geodata-collection-goundwork-report/)
- [Phase 3 Plan: Framework](/library/geodata-collection-framework-plan/)
...
We are currently in [Phase 4: Framework](#phase-4-framework-2026).
...
_Communicate our newly developed capabilities and seek out data provider partnerships for our first collections._

- [x] Sunset the pilot workgroup.
- [x] Convene a Data Curation Workgroup.
...
_Work iteratively with our data providers to collect, document, and publish prior versions of their datasets._

- [x] Establish partnership with a second data provider
- [x] Ingest datasets submitted by two partners
- [x] Review the initial collection
- [x] Work with partners to refine the metadata and datasets for their original content as displayed in the Geoportal
- [x] Publish a [Curation Plan, Version 1](https://drive.google.com/file/d/1YRro4a98Hi-W1iduV_TF1Ic_vp2uMcz5/view) to document scope, metadata, and workflows.
- [x] Sunset the [Geodata Curation Workgroup](/workgroups/geodata-curation/)
- [x] Produce a report documenting the Foundation phase, the next steps, and an updated roadmap

<hr/>

### Phase 4: Framework (2026)

In the Framework Phase, we will build up our collections with more data providers. This will require broader communication and more outreach.

#### Phase 4a Q2 2026

- [x] Define updated scope and collection framework
- [x] Establish a plan for regular collection cycles
- [x] Initiate engagement with at least two additional data providers

<div class="gold-highlight">

#### Phase 4b Q3 2026

- [ ] Collaborate with development team to support asset-based workflows (e.g., batch upload, bundled downloads with metadata)
- [ ] Complete initial Urban Base Layers plan for all identified cities that are available

</div>

#### Phase 4c Q4 2026

- [ ] Conduct outreach to broader communities (e.g., GIS Day, FOSS4G)
- [ ] Ingest at least four new collections
