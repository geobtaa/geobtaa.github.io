...
- [ ] Define updated scope and collection framework
- [ ] Establish a plan for regular collection cycles
- [ ] Initiate engagement with at least two additional data providers
