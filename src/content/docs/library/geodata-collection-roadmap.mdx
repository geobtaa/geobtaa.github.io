...
We are currently in [Phase 3: Foundation, 3b. Collection & Curation Plan](#phase-3-foundation).
...
- [ ] Produce a report documenting the Foundation phase, the next steps, and an updated roadmap
