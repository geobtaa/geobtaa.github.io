...
<FloatFigure>
![a green and blue raised relief map of the Great Lakes hangs on a red wall. Below it, is a row of blue buttons, and a visitor is pressing one to light up several red points on the map](@images/mapswild_greatlakesrelief.png)
...
<FloatFigure>
![A nautical chart of Lake Superior enlarged and projected on a wall, with lines showing ships’ routes and  blue and white text bubbles pointing out important points in time on November 10, 1975](@images/mapswild_nauticalsuperior.png)
...
<FloatFigure>
![a colorful mosaic above a bookshelf](@images/mapswild_studentmosaic.png)
*Colorful mosaic*
</FloatFigure>
...
<FloatFigure>
![colorful map of Michigan and the Great Lakes. Fountains, animals, tents, and buildings make up the border, while on the map an Indigenous man and a European man on a horse face each other from opposite corners](@images/mapswild_wileymichigan.png)
